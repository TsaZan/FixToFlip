...
class DashboardViewTest(TestCase):
    def setUp(self):
        ...
        Property.objects.create(
            ...
            owner=self.user,
            property_condition="Under repair",
        )
        Property.objects.create(
            property_name="Property 2", owner=self.user, property_condition="For sale"
        )
        Property.objects.create(
            property_name="Property 3", owner=self.user, property_condition="Sold"
        )
        ...
        Property.objects.create(
            property_name="Property 4", owner=other_user, property_condition="For sale"
        )
