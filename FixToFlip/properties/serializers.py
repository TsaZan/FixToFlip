...
def finance_property_data(property_instance, financial_data, expenses_data):
    for finance in financial_data:
        PropertyFinancialInformation.objects.create(
            property=property_instance, **finance
        )
...
class PropertySerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        property_financial_data = validated_data.pop(
            "property_financial_information", []
        )
        ...
        finance_property_data(
            new_property, property_financial_data, property_expenses_data
        )
...
class ExpenseNotesCreateSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        expense_note = PropertyExpenseNotes.objects.create(
            relates_expenses=relates_expenses, **validated_data
        )
